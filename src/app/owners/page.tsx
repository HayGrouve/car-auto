  ...
  return (
    <main className="p-6 max-w-6xl mx-auto space-y-4">
      <div className="flex items-center justify-between gap-2">
        ...
        <Button className="md:hidden" variant="outline" onClick={() => setShowCreatePanel(true)} aria-label="Нов собственик">Нов собственик</Button>
      </div>
          ...
          <div className="border rounded-md p-4 space-y-3">
            ...
            <form onSubmit={handleCreate} className="grid grid-cols-1 gap-3">
              ...
              <label className="flex items-center gap-2">
                ...
                <Link href="/privacy" className="text-xs text-muted-foreground underline underline-offset-2">Политика</Link>
              </label>
              <div>
                <Button type="submit" className="w-full md:w-auto">Добави собственик</Button>
              </div>
            </form>
          </div>
        </aside>
