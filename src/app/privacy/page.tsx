  ...
  return (
    <main className="max-w-3xl mx-auto p-6 space-y-4">
      ...
      <section className="space-y-2 text-sm">
        ...
        <p>Съхраняваме само необходимите данни за предоставяне на услугата. Прилагаме минимизация и периодично преглеждаме непотребни записи.</p>
        <p>Сроковете за съхранение се определят от законови изисквания и медицинска документация; при конфликт се използва правен запор (legal hold).</p>
      </section>
    </main>
  );
}
